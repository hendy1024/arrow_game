'use strict';
const { validateLevel, DIRS, key, firstBlocker } = require('../domain/board');
function solve(level) {
    ...
    while (pending.size) {
        ...
        for(const d of level.doors||[])if(!require('../domain/doors').isOpen(d,level,removed))require('../domain/doors').block(d,used);
